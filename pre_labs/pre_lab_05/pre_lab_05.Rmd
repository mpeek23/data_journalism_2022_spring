...
**Answer**
Misspellings, capitalization, etc.
```{r}
...
**Answer**
Changed PHOENIX to Phoenix, changed WESTMINSTER to Westminster
```{r}
...
**Answer**
Changed ABELL to Abell, changed aberdeen to Aberdeen, changed ABERDEEN to Aberdeen
```{r}
cleaned_md_loans %>%
...
**Answer**
No, it made about the same changes as the previous code.
```{r}
cleaned_md_loans <- md_loans %>%
