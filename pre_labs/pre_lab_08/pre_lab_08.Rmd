...
**Answer**
No, their margin of error makes them basically the same value in terms of our data.

Is the difference between Howard and everyone else significant?
**Answer**
I would say fairly. Howard is the clear highest median income, with Montgomery/Calvert fairly close behind and a gradient of values behind them.
...
**Answer**
Somerset County saw the greatest median income fall, at a -10.93 change and Caroline County also fell at -0.27. For Somerset County, it seems that change is outside the margin of error because the max and mins of the years are extrememly narrow while the percentage change is great. For Caroline County, the change is small and the margin of errors are larger, so we can be more confident that this is accurate.
```{r}
md10 %>%
