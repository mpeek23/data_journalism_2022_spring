...
**Answer**
A list of data in unfamilar formats to us
```{r, echo=FALSE}
...
**Answer**
We have a lot of standard character columns, and a cool new one, point!
```{r}
...
**Answer**
It createsa new data frame with just maryland hospitals
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It groups by the type of hospitals (GENERAL ACUTE CARE,	PSYCHIATRIC, MILITARY, CHRONIC DISEASE, LONG TERM CARE, REHABILITATION, SPECIAL) and counts them
```{r}
md_hospitals %>%
  group_by(TYPE) %>%
  summarise(
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It gives us just the general acute care hospitals in Maryland
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It plots the general accute care hospitals on a latitude and longitude graph
```{r}
md_hospitals %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It grabs a bunch of counties and makes them into a new data frame
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It filters to Maryland counties
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It plots hospitals on to Maryland!
```{r}
ggplot() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It makes a legend for the number of beds and assigns them to the data points
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Filters to 50 general acute care hospitals in MD
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Makes a new data frame breaking down hospital beds by county
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Makes a new data frame with Maryland county populations
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Brings geometry in the md county population dataframe
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Cleans up md county population by making it match up with bed data frame
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Joins MD county population data with MD county beds
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Makes NA beds display 0 instead
```{r}
md_beds_per_100k <- md_county_population %>%
  left_join(md_beds_by_county) %>%
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Does the math to find per 100,000 population and arranges them smallest to largest
```{r}
md_beds_per_100k <- md_county_population %>%
  left_join(md_beds_by_county) %>%
  mutate(total_beds = replace_na(total_beds,0)) %>%
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Maps the distribution of hospital beds per 100,000 people
```{r}
ggplot() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Changes map colors to a red/purple/yellow color scheme
...
**Answer**
Adds more colors to show differences in area
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
