...
**Answer**
It is the industry classification overview! It has a ton of information about NAICS and industry classifications.
### Task 3: Load image
...
**Answer**
Under view source, you can see the html code that builds the webpage.
...
**Answer**
You get a list of the code tags in the html.
```{r}
# read in the html
...
**Answer**
The naics_industry data pulls the html tags from the website and gives some information about them, like the data type and how many elements are in the list, etc.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
The inspect element shows the html code that builds the table.
...
**Answer**
It makes tibbles of roughly what's in the tables on the webpage.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
It shows a list of the different tibbles and gives brief information of their make-up.
...
**Answer**
It shows the information from the tibbles in task 10 in a condensed version- roughly what is on the tables from the website.
...
**Answer**
It gives us just the table we want.
```{r}
...
**Answer**
Cuts off the source, made the table information uniform.
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
It shows the html information of the website
...
**Answer**
It gives the html information of the table.
...
**Answer**
It pulls the data from the table.
...
**Answer**
Isolated the title of row 2 but assigned it the data from row 1.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Workforce statistics on mining, quarrying, oil and gas extraction.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Workforce statistics on construction.
...
**Answer**
Creates a list of the titlles typed out
...
**Answer**
Creates a value with a list of titles
```{r}
...
**Answer**
It runs an error because it calls the wrong title for the list value
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
It exports the list because we call it by the correct name
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
It gives an error because we didn't define sector_name
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
It  gives our our original table of the NAICS codes
```{r}
...
**Answer**
Writes the number of rows in the table (20)
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
...
**Answer**
It gives the employment statistic for all employees (seasonally adjusted) in November 2021
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
Loads the table of the NAICS codes and cleans the data
```{r}
# Define url of page we want to scrape
...
**Answer**
It adds the corresponding page to the industry.
```{r}
...
**Answer**
It adds the X path to the corresponding sector/industry
```{r}
...
**Answer**
Removed the Public Administration row
```{r}
...
**Answer**
It makes tibbles  for each industry
```{r}
...
**Answer**
it generates a list of rows and assigns it a link and xpath
```{r}
...
**Answer**
It assigns a table for each row
```{r}
...
**Answer**
It somewhat unifies the data being provided for each row
```{r}
...
**Answer**
It added more information, like the industry description, link, xpath, etc.
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
Made the data more readable by putting sector, industry name, and Nov 21 employees rate
```{r}
...
**Answer**
Makes a lovely table with all of our data
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
The mining, quarrying and oil employment statisitcs
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Agriculture,forestry,  fishing and hunting employment statistics
...
**Answer**
Removed suspicious values from the table.
```{r}
