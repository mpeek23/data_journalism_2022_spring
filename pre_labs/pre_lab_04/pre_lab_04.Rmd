...
**Answer**
Error in join rows- you can't join the rows because they have a different format.
```{r}
...
**Answer**
No, not all the data was able to be matched.
...
**Answer**
Average amount is $55,546.84 and the median amount is $19,949. 
```{r}
...
**Answer**
The average amount $89,194.67 and the median amount was $20,833
```{r}
...
**Answer**
For rural populations, the average amount was $44,815.22 and the median amount was $19,064.57
For urban populations, the average amount was $55,584.05 and the median amount was $19,950.
```{r}
...
**Answer**
For the rural populations, the average amount was $74,462.32 and the median amount was $20,833.
For the urban populations, the average amount was $92,029.32 and the median amount was $20,833.
