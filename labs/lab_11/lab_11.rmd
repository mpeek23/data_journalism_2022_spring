...
wv_map_mines<- wv_county_population %>%
  left_join(mining_quarrying, by=c("COUNTY"= "project_county_name")) %>% 
...
The two areas with the most loans are Clay County WV and Tucker County WV, which are the least populated counties in the state. It seems like the more rural counties had more loans per 100,000 people while the more populated counties like Kanawha had less loans per 100,000 people.
